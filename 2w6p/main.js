...
tryIt.addEventListener('click', () => {
	perfwasm0 = performance.now();               //¼ÆÊ±t0
	...
	let message1 = {data0:ctx0.getImageData(0,0,canvas0.width,canvas0.height),data1:ctx1.getImageData(0,0,canvas1.width,canvas1.height),data2:ctx2.getImageData(0,0,canvas2.width,canvas2.height),data3:ctx3.getImageData(0,0,canvas3.width,canvas3.height)};
	let message2 = {data0:ctx0.getImageData(0,0,canvas0.width,canvas0.height),data1:ctx4.getImageData(0,0,canvas4.width,canvas4.height),data2:ctx5.getImageData(0,0,canvas5.width,canvas5.height),data3:ctx6.getImageData(0,0,canvas6.width,canvas6.height)};
